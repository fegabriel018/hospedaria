...
<div class="card card-outline card-info rounded-0">
	<div class="card-header">
		<h3 class="card-title">Lista de Mansagem</h3>
	</div>
	<div class="card-body">
					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if($row['status'] == 1): ?>
									<span class="badge badge-pill badge-success">Ler</span>
								<?php else: ?>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Tem certeza de que deseja excluir esta mensagem permanentemente?","delete_message",[$(this).attr('data-id')])
		})
