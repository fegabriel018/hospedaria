...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Recreação</h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Adicionar nova recreação</a>
		</div>
	</div>
	<div class="card-body">
						...
						<tr>
							...
							<td class="text-center">
								<?php 
									switch ($row['status']){
										case 0:
											echo '<span class="rounded-pill badge badge-danger col-6">Inativo</span>';
											break;
										case 1:
											echo '<span class="rounded-pill badge badge-success col-6">Ativo</span>';
											break;
									}
								?>
							</td>
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Adicionar nova recreação","activities/manage_activity.php",'mid-large')
		})
        $('.edit_data').click(function(){
			uni_modal("Atualizar de detalhes recreção","activities/manage_activity.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.delete_data').click(function(){
			_conf("Excluir recreação permanentemente?","delete_activity",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("Detalhes de recreação","activities/view_activity.php?id="+$(this).attr('data-id'))
		})
