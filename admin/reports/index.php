...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Relatório de Reservas</h3>
	</div>
	<div class="card-body">
        <fieldset>
            <legend class="text-muted">Filtrar</legend>
            <form action="" id="filter-report">
                <div class="row align-items-end">
                    <div class="form-group col-md-3">
                        <small class="text-muted mx-2">Data De</small>
                        <input type="date" name="from" value="<?= $from ?>" class="form-control form-control-sm rounded-0" required>
                    </div>
                    <div class="form-group col-md-3">
                        <small class="text-muted mx-2">Data Para</small>
                        <input type="date" name="to" value="<?= $to ?>" class="form-control form-control-sm rounded-0" required>
                    </div>
                    <div class="form-group col-md-3">
                        <button class="btn btn-primary btn-flat btn-sm"><i class="fa fa-filter"></i> Filtrar</button>
        ...
        <div class="container-fluid" id="outprint">
            ...
            <div id="show-print">
                <div class="w-100 position-relative">
                    ...
                    <h4 class="text-center"><b>Lista de Reservas</b></h4>
                    <center><small>
                        <?php 
                        if($from == $to){
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
								...
								<?php 
									switch ($row['status']){
										...
										case 1:
											...
											break;
										case 2:
											echo '<span class="rounded-pill badge badge-danger col-6">Cancelada</span>';
											break;
									}
								?>
							</td>
                    ...
                    <?php if($qry->num_rows <= 0): ?>
                        <tr>
                            <th class="text-center" colspan="6">Sem dados</th>
                        </tr>
                    <?php endif; ?>
				</tbody>
			</table>
