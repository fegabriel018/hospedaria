...
<div class="card card-outline card-primary rounded-0 shadow mb-5">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button class="btn btn-primary btn-sm btn-flat" type="button" id="edit_room"><i class="fa fa-edit"></i> Editar Detalhes</button>
            <button class="btn btn-danger btn-sm btn-flat" type="button" id="delete_room"><i class="fa fa-trash"></i> Excluir</button>
...
<script>
    ...
    $(function(){
        $('#edit_room').click(function(){
            uni_modal("Atualizar detalhes do Quarto","rooms/manage_room.php?id=<?= isset($id) ? $id : '' ?>",'large')
        })
        $('#delete_room').click(function(){
            _conf("Tem certeza de que deseja excluir este Quarto permanentemente?","delete_room",[])
        })
    })
</script>