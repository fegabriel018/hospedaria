            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select name="type" id="type" class="form-control form-control-border" placeholder="Enter room Name" required>
                        <option value="" <?= !isset($type) ? "selected" : '' ?> disabled> Selecione aqui</option>
                        <option <?= isset($type) && $type == 'Single' ? 'selected' : "" ?>>Normal</option>
                        <option <?= isset($type) && $type == 'Double' ? 'selected' : "" ?>>VIP</option>
    ...
    $(function(){
        $('#uni_modal').on('shown.bs.modal',function(){
            $('#description').summernote({
                placeholder:'Escreva a descrição do quarto aqui.',
                height: '50vh',
		        toolbar: [
		            [ 'style', [ 'style' ] ],
